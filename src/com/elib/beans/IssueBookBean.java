...
public class IssueBookBean {
	...
	public IssueBookBean(String callno, String studentid, String studentname, long studentmobile )
	{
		...
		this.studentmobiel = studentmobile;
	}
	...
	public long getStudentmobiel()
	{
		return studentmobiel;
	}
	public void setStudentmobiel(long studentmobiel)
	{
		this.studentmobiel = studentmobiel;
	}
}
